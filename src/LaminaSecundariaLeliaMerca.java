...
public class LaminaSecundariaLeliaMerca extends JPanel {
    ...
    private String[] arrayPrecios1Club = new String[4];
    boolean bandera1 = CalcularPrecios(arrayPrecios1, arrayPrecios1Club, 0.10);
    ...
    private boolean CalcularPrecios(String[] arrayInicio, String[] arrayFinal, double porcentaje) {
        ...
        for (int i = 0; i < precios.length; i++) {
            precio = Double.parseDouble(arrayInicio[i]);
